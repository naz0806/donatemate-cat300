...
<section class="sidebar">
  <ul class="menu">
    ...
    <li class="menu-item">
      <a href="charity-list-v2.php" class="menu-link" data-content="Charity List">Charity List</a>
    </li>
    <li class="menu-item">
        <a href="donor-dash-page.php" class="menu-link" data-content="Dashboard">Dashboard</a>
      </li>
      <li class="menu-item">
